            ...
            <div className="filters mb-3">
                <div className="d-flex justify-content-between align-items-center">
                    <Radio.Group defaultValue="a" buttonStyle="solid">
                        <Radio.Button className="filter-radio-item" value="a">Самые последние</Radio.Button>
                        <Radio.Button className="filter-radio-item mx-3" value="b">Лучшие ежедневные</Radio.Button>\
                        <Radio.Button className="filter-radio-item" value="c">Лучшие еженедельные</Radio.Button>\
                    </Radio.Group>
                    <Select
                        allowClear
